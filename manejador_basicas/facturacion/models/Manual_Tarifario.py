...
class Manual_Tarifario(models.Model):
    id_servicio = models.ForeignKey(Servicio, on_delete=models.CASCADE, unique=True)
    id_contrato = models.ForeignKey(Contrato, on_delete=models.CASCADE, unique=True)
